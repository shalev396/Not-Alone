...
export default function NewDonation() {
  ...
  const initialValues: DonationForm = {
    city: "",
    address: "",
    category: "Furniture",
    title: "",
        ...
        <div className="container max-w-3xl py-6 pl-20 md:pl-6">
          <div className="mb-8 text-center">
            ...
            <p className="text-lg text-muted-foreground mt-2">
              Support our Lone Soldiers by donating essential items
            </p>
          </div>
                  ...
                  <Form className="space-y-6">
                    <div className="grid gap-6">
                      <FormItem>
                        ...
                        {touched.city && errors.city && (
                          <FormMessage>{errors.city as string}</FormMessage>
                        )}
                      </FormItem>
                      ...
                      <FormItem>
                        ...
                        {touched.address && errors.address && (
                          <FormMessage>{errors.address as string}</FormMessage>
                        )}
                      </FormItem>
