          ...
          <DialogDescription className="pt-4 space-y-4">
            ...
            <div className="border-l-4 border-yellow-400 pl-4 bg-yellow-50 dark:bg-yellow-900/10 p-4 rounded">
              <p className="text-sm text-muted-foreground">
                ...
                All content, including but not limited to statistics, user
                counts, donation amounts, and service availability, is simulated
                and not intended for public use. We make no warranties or
                guarantees regarding the accuracy, reliability, or accessibility
                of the information presented. By continuing to use this website,
                you acknowledge that you understand this is a development
                environment and agree not to rely on any information or services
                provided herein for any purpose.
              </p>
            </div>
          </DialogDescription>
        </DialogHeader>
